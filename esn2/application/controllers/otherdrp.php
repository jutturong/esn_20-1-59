...
var  $tb_main="otherdrp";
       ...
       public  function loadOtherdrp()
       {
          ...
          // $this->db->join($tb_sub,$tb.'.Lab='.$tb_sub.'.LabCode','left');
           ...
           $this->db->join($tbj1,$tb.".DRPselection3=".$tbj1.".id_drp","left");
           
             $tba="tb_action";
             $this->db->join($tba,$tb.".Action3=".$tba.".id_action","left");
             
             
           $tbr="tb_result";
           $this->db->join($tbr,$tb.".Response3=".$tbr.".id_result","left");
      ...
      #http://drugstore.kku.ac.th/esn2/index.php/otherdrp/loadOtherdrpHN/ab3540
