...
var  $tb_main="06_giveinformation"; 
      ...
      {
          $tb=$this->tb_main;
          echo $HN_give=trim($this->input->get_post('HN_give'));
          //echo "<br>";
          echo     $MonitoringDate_give=trim($this->input->get_post('MonitoringDate_give'));
          //echo "<br>";  
          echo   $GiveInformation1=trim($this->input->get_post('GiveInformation1'));
          echo   $GiveInformation2=trim($this->input->get_post('GiveInformation2'));
          echo   $GiveInformation3=trim($this->input->get_post('GiveInformation3'));
          echo   $GiveInformation4=trim($this->input->get_post('GiveInformation4'));
          echo   $GiveInformation5=trim($this->input->get_post('GiveInformation5'));
          echo   $GiveInformation6=trim($this->input->get_post('GiveInformation6'));
